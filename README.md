# SQL
## Select
Файл с выполненным заданием: [SQL_Select.sql]("https://github.com/Jornipam/SQL/blob/92dc7e5aa2f3c5570f79c5bdccf8344f0785e5b5/SQL_Select.sql")
...
## DML
Файл с выполненным заданием: [SQL_DML.sql]
